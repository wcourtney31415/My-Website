...
var $author$project$Main$init = function (flags) {
	var windowWidth = flags.windowWidth;
	var windowHeight = flags.windowHeight;
	var device = $mdgriffith$elm_ui$Element$classifyDevice(
		{height: windowHeight, width: windowWidth});
	var initialModel = {contactDropdown: $author$project$MessagesAndModels$Closed, device: device, responsive: true, selectedPage: $author$project$MessagesAndModels$Home, windowHeight: windowHeight, windowWidth: windowWidth};
	return _Utils_Tuple2(initialModel, $elm$core$Platform$Cmd$none);
};
var $elm$json$Json$Decode$int = _Json_decodeInt;
var $author$project$MessagesAndModels$GotNewResolution = F2(
	function (a, b) {
	...
	function (msg, model) {
		switch (msg.$) {
			...
			default:
				...
				var device = $mdgriffith$elm_ui$Element$classifyDevice(
					{height: height, width: width});
				var modifiedModel = _Utils_update(
					model,
					{device: device, windowHeight: height, windowWidth: width});
				return _Utils_Tuple2(modifiedModel, $elm$core$Platform$Cmd$none);
		}
	});
...
var $author$project$HelperFunctions$convertColor = function (color) {
	var _this = $avh4$elm_color$Color$toRgba(color);
	var eUIColor = A4($mdgriffith$elm_ui$Element$rgba, _this.red, _this.green, _this.blue, _this.alpha);
	return eUIColor;
};
...
var $author$project$Desktop$Colors$grayFortyTwo = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 42, 42, 42));
...
var $author$project$BasicColors$white = $author$project$HelperFunctions$convertColor($avh4$elm_color$Color$white);
...
var $author$project$Desktop$Index$grey = function (y) {
	return A3($mdgriffith$elm_ui$Element$rgb255, y, y, y);
};
var $mdgriffith$elm_ui$Internal$Model$Top = {$: 'Top'};
var $mdgriffith$elm_ui$Element$alignTop = $mdgriffith$elm_ui$Internal$Model$AlignY($mdgriffith$elm_ui$Internal$Model$Top);
var $author$project$Data$facePath = './Images/me.png';
...
var $author$project$Desktop$Index$imageOfMe = function () {
	var size = 250;
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
				...
				A3($mdgriffith$elm_ui$Element$rgb255, 165, 169, 172)),
				$mdgriffith$elm_ui$Element$Border$shadow(
				{
					blur: 10,
					color: A3($mdgriffith$elm_ui$Element$rgb255, 0, 0, 0),
					offset: _Utils_Tuple2(4, 2),
					size: 1
				})
			]),
		_List_fromArray(
			[
				...
				{description: 'An image of Wes Courtney', src: $author$project$Data$facePath})
			]));
}();
...
var $author$project$Desktop$Index$frontPageParagraph = function () {
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$Background$color(
						$author$project$Desktop$Index$grey(10)),
		...
		_List_fromArray(
			[
				$author$project$Desktop$Index$imageOfMe,
				A2(
				$mdgriffith$elm_ui$Element$column,
				_List_fromArray(
					[
				...
				A2(
					...
					_List_fromArray(
						['Welcome to my site! My name is Wes Courtney, and I am a software developer. Coding is my passion and I have been doing it for 19 years.', 'My career in software development began with video game design when I was in 5th grade.', 'Over the years I found that my gratification wasn\'t exclusive to game design but was instead the product of coding itself. This broadened my horizon, and opened me up to new languages and paradigms.', 'Today I code in my professional endeavors, and also as a hobby, and  aspire to make a full time career of it.', 'For career related inquiries, contact me at wcourtney31415@gmail.com'])))
			]));
}();
...
var $author$project$Desktop$Navbar$hovered = $mdgriffith$elm_ui$Element$mouseOver(
	_List_fromArray(
		[
			A2($mdgriffith$elm_ui$Element$Font$glow, $author$project$BasicColors$white, 3.5)
		]));
var $author$project$Desktop$Navbar$aboutMe = function (model) {
	return A2(
...
var $author$project$Desktop$Colors$dropNavColor = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 105, 108, 112));
...
var $author$project$BasicColors$shadowColor = $author$project$HelperFunctions$convertColor(
...
var $author$project$Desktop$Navbar$dropNav = function () {
	...
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Desktop$Colors$dropNavColor),
				...
				A2($mdgriffith$elm_ui$Element$Font$glow, $author$project$BasicColors$white, 0)
			]),
		_List_fromArray(
			[emailClientLnk, emailClipboardLnk]));
}();
var $author$project$MessagesAndModels$Open = {$: 'Open'};
var $author$project$HelperFunctions$speedIf = F3(
	function (condition, result, elseResult) {
		return condition ? result : elseResult;
	});
var $author$project$HelperFunctions$flip = function (a) {
	return A3(
...
var $author$project$Desktop$Navbar$contactButton = function (model) {
	...
	var dropNavIfOpen = A3(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$below($author$project$Desktop$Navbar$dropNav),
				A2($mdgriffith$elm_ui$Element$Font$glow, $author$project$BasicColors$white, 3.5)
			]));
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
...
var $author$project$Desktop$Navbar$gitHubLink = A2(
...
var $author$project$Desktop$Navbar$navBar = function (model) {
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Desktop$Navbar$contactButton(model),
				$author$project$Desktop$Navbar$aboutMe(model),
				$author$project$Desktop$Navbar$gitHubLink
			]));
};
var $author$project$Desktop$View$desktopView = function (model) {
	...
	return A3(
		$mdgriffith$elm_ui$Element$layoutWith,
		{
			options: _List_fromArray(
				[
					$mdgriffith$elm_ui$Element$focusStyle(myFocusStyle)
				])
		},
		_List_fromArray(
			[
...
var $author$project$Phone$Colors$grayThirtyFour = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 234, 234, 234));
...
var $author$project$Phone$Colors$gray = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 200, 200, 200));
var $author$project$Phone$Colors$lightestBlue = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 182, 205, 226));
...
var $author$project$Phone$Colors$darkerBlue = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 65, 115, 164));
var $author$project$Phone$Colors$lighterBlue = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 102, 148, 194));
...
var $author$project$Phone$GithubComp$gitHubContentComp = function () {
	...
	var siteSourceLink = A2(
		...
		linkAttributes,
		{
			label: $mdgriffith$elm_ui$Element$text('Site Source'),
			url: $author$project$Data$siteSource
		});
	var gitHubLink = A2(
		$mdgriffith$elm_ui$Element$newTabLink,
		linkAttributes,
		{
			label: $mdgriffith$elm_ui$Element$text('My Github'),
			url: $author$project$Data$gitHub
		});
	var buttons = A2(
		$mdgriffith$elm_ui$Element$row,
...
var $author$project$Phone$GithubComp$githubComponent = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$Font$size(65)
				]),
			_List_fromArray(
				[
...
var $author$project$Phone$Colors$myNameColor = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 52, 89, 127));
var $author$project$Phone$Colors$viewHeaderCol = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 101, 147, 193));
	...
	var titleSdev = A2(
		...
		_List_fromArray(
			[
				...
				$mdgriffith$elm_ui$Element$Border$roundEach(
				{bottomLeft: 50, bottomRight: 50, topLeft: 0, topRight: 0})
			]),
		_List_fromArray(
			[
				A2(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					$mdgriffith$elm_ui$Element$Background$gradient(
					{
						...
						steps: _Utils_ap(
							A2(
								...
								1,
								A3($mdgriffith$elm_ui$Element$rgb255, x, x, x)),
							_Utils_ap(
								A2(
									$elm$core$List$repeat,
									1,
									A3($mdgriffith$elm_ui$Element$rgb255, y, y, y)),
								A2(
									$elm$core$List$repeat,
									1,
					...
					$mdgriffith$elm_ui$Element$paddingEach(
					{bottom: 70, left: 20, right: 20, top: 20})
				]),
			_List_fromArray(
				[
					A2(
...
var $author$project$Phone$View$imageOfMe = function () {
	var size = 400;
	return A2(
		$mdgriffith$elm_ui$Element$el,
		_List_fromArray(
...
var $author$project$Phone$Colors$gradientColor1 = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 228, 228, 228));
var $author$project$Phone$Colors$lighterGray = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 230, 230, 230));
...
var $mdgriffith$elm_ui$Element$layout = $mdgriffith$elm_ui$Element$layoutWith(
	{options: _List_Nil});
var $author$project$Phone$Colors$theBackground = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 194, 194, 194));
	...
	A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$author$project$Phone$View$imageOfMe,
						A3(
...
var $author$project$Tablet$Colors$grayFortyTwo = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 42, 42, 42));
...
var $author$project$Tablet$Index$imageOfMe = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
		[
			$mdgriffith$elm_ui$Element$padding(12),
...
var $author$project$Tablet$Index$titleBox = A2(
	...
	_List_fromArray(
		[
			$author$project$Tablet$Index$imageOfMe,
			A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
...
var $author$project$Tablet$Index$homepageItems = A2(
	$mdgriffith$elm_ui$Element$column,
	_List_fromArray(
...
var $author$project$Tablet$Navbar$aboutMe = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
...
var $author$project$Tablet$Colors$dropNavColor = $author$project$HelperFunctions$convertColor(
	A3($avh4$elm_color$Color$rgb255, 105, 108, 112));
var $author$project$Tablet$Navbar$dropNav = function () {
	var emailClipboardLnk = A2(
		$mdgriffith$elm_ui$Element$Input$button,
		_List_fromArray(
			[$author$project$Tablet$Navbar$hovered]),
	...
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Tablet$Colors$dropNavColor),
				$mdgriffith$elm_ui$Element$moveDown(15),
...
var $author$project$Tablet$Navbar$contactButton = function (model) {
	var flippedState = $author$project$HelperFunctions$flip(model.contactDropdown);
	var toggledModel = _Utils_update(
		model,
		{contactDropdown: flippedState});
	var dropNavIfOpen = A3(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$below($author$project$Tablet$Navbar$dropNav),
				A2($mdgriffith$elm_ui$Element$Font$glow, $author$project$BasicColors$white, 3.5)
			]));
	return A2(
		$mdgriffith$elm_ui$Element$Input$button,
...
var $author$project$Tablet$Navbar$gitHubLink = A2(
	$mdgriffith$elm_ui$Element$newTabLink,
	_List_fromArray(
		[$author$project$Tablet$Navbar$hovered]),
	{
...
var $author$project$Tablet$Navbar$navBar = function (model) {
	var bkgAttr = $author$project$HelperFunctions$bkgAttributes(
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$Background$color($author$project$Tablet$Colors$grayFortyTwo),
	...
	return A2(
		...
		_List_fromArray(
			[
				$author$project$Tablet$Navbar$contactButton(model),
				$author$project$Tablet$Navbar$aboutMe(model),
				$author$project$Tablet$Navbar$gitHubLink
			]));
};
var $author$project$Tablet$View$tabletView = function (model) {
	var selectedPage = function () {
		var _v0 = model.selectedPage;
		if (_v0.$ === 'Home') {
				...
				$mdgriffith$elm_ui$Element$Background$gradient(
				{
					...
					steps: _List_fromArray(
						[
							...
							A3($mdgriffith$elm_ui$Element$rgb255, 109, 160, 182),
							A3($mdgriffith$elm_ui$Element$rgb255, 204, 222, 229),
...
var $author$project$View_Controller$siteView = function (model) {
	...
	var responsiveView = function () {
		switch (deviceClass.$) {
			...
			case 'Desktop':
				return $author$project$Desktop$View$desktopView(model);
			default:
				return $author$project$Desktop$View$desktopView(model);
		}
	}();
	var defaultView = $author$project$Desktop$View$desktopView(model);
	var myView = model.responsive ? responsiveView : defaultView;
	return myView;
};
var $author$project$Main$view = function (model) {
	return {
		body: _List_fromArray(
			[
				$author$project$View_Controller$siteView(model)
			]),
		title: $author$project$Data$myName
	};
};
